...
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    init_chunks();
    css = {
      code: "body{margin:0;font-family:'Roboto', sans-serif}.mainMenu{display:flex;justify-content:space-between;align-items:center;background-color:#3f99a6;list-style:none;padding:10px;margin:0}.mainMenu__item{padding:0 10px}.mainMenu__link{color:white;padding:10px;text-decoration:none}footer{display:flex;justify-content:center;align-items:center;flex-direction:column;padding:10px;font-size:20px;background-color:#c3d6f1}",
      map: null
    };
    Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css);
      return `<header class="${"main-header"}">Juan perez - Desarrollador web</header>
<nav class="${"nav"}"><ul class="${"mainMenu"}"><li class="${"mainMenu__item"}"><a href="${"/"}" class="${"mainMenu__link"}">Inicio</a></li>
    <li class="${"mainMenu__item"}"><a href="${"/nosotros"}" class="${"mainMenu__link"}">Nosotros</a></li>
    <li class="${"mainMenu__item"}"><a href="${"/clientes"}" class="${"mainMenu__link"}">Clientes</a></li>
    <li class="${"mainMenu__item"}"><a href="${"/contactos"}" class="${"mainMenu__link"}">Contactos</a></li></ul></nav>
${slots.default ? slots.default({}) : ``}

<footer><p>Todos los derechos reservados Juan Perez - Desarrollo web</p>
</footer>`;
    });
  }
});
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    file = "_app/immutable/components/pages/_layout.svelte-1c98053e.js";
    imports = ["_app/immutable/components/pages/_layout.svelte-1c98053e.js", "_app/immutable/chunks/index-98708bfc.js"];
    stylesheets = ["_app/immutable/assets/_layout-65553b37.css"];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    file2 = "_app/immutable/components/error.svelte-c2aa5e5a.js";
    imports2 = ["_app/immutable/components/error.svelte-c2aa5e5a.js", "_app/immutable/chunks/index-98708bfc.js", "_app/immutable/chunks/singletons-dd516ea2.js"];
    stylesheets2 = [];
  }
});
...
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    init_chunks();
    css2 = {
      code: ".main-header{padding:10px;display:flex;justify-content:center;align-items:center}.section-bg__header-bg{color:white;display:flex;flex-direction:column;justify-content:center;align-items:center;height:100%;position:absolute;font-size:30px;z-index:150;width:100%}.section-bg__header-bg-location.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{display:flex;justify-content:center;align-items:center}.section-bg__header-bg-button.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{cursor:pointer;background-color:#3f99a6;display:flex;justify-content:center;align-items:center;margin-top:20px;border-radius:4px;outline:none;border:0;padding:8px;font-size:25px}.section-bg__header-bg-button.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y:hover{background-color:#347e8a}.img-background.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{background-image:url('/mac.jpg');background-size:cover;background-repeat:no-repeat;background-position:center;height:inherit;display:flex;justify-content:center;align-items:center;position:relative;z-index:10;opacity:0.5}.layer-black.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{position:absolute;z-index:100;width:100%;background-color:rgba(0, 0, 0, 0.9);height:inherit}.section-bg.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{position:absolute;width:100%;z-index:10;height:calc(100vh - 300px)}.section-bg.svelte-1yhtx2y p.svelte-1yhtx2y.svelte-1yhtx2y{font-size:20px}.main.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{margin-top:500px}.section-services.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{display:grid;grid-template-columns:repeat(3, 1fr);gap:10px}.section-services.svelte-1yhtx2y header.svelte-1yhtx2y.svelte-1yhtx2y{text-align:center;font-size:25px;padding:10px}.section-services.svelte-1yhtx2y article.svelte-1yhtx2y.svelte-1yhtx2y{padding:10px;text-align:center}.section-services.svelte-1yhtx2y article p.svelte-1yhtx2y.svelte-1yhtx2y{line-height:2}.main__header.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{display:flex;justify-content:center;align-items:center;font-size:25px}.article__bg-icon.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{background-color:#f7bd45;border-radius:100%;width:100px;height:100px;display:flex;justify-content:center;align-items:center;margin:0 auto}.contact.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{display:flex;justify-content:center;align-items:center;flex-direction:column;padding:10px;font-size:40px}.form.svelte-1yhtx2y h3.svelte-1yhtx2y.svelte-1yhtx2y{color:#f7bd45}.form.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{display:flex;width:100%;justify-content:center;align-items:center;flex-direction:column;background-color:#757575}.form.svelte-1yhtx2y input.svelte-1yhtx2y.svelte-1yhtx2y,textarea.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{padding:10px;margin:10px;border:none;border-radius:5px;flex-grow:1}.form__second-section.svelte-1yhtx2y textarea.svelte-1yhtx2y.svelte-1yhtx2y{height:100px}.form__first-section.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{width:50%;display:flex}.form__first-section.svelte-1yhtx2y label.svelte-1yhtx2y input.svelte-1yhtx2y{flex-grow:1}.form__first-section.svelte-1yhtx2y label.svelte-1yhtx2y.svelte-1yhtx2y{display:flex;justify-content:center;align-items:center;width:100%;color:white}.form__second-section.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{display:flex;flex-direction:column;width:50%}.form__second-section.svelte-1yhtx2y label.svelte-1yhtx2y.svelte-1yhtx2y{display:flex;justify-content:center;align-items:center;gap:10px;width:100%;color:white}textarea.svelte-1yhtx2y.svelte-1yhtx2y.svelte-1yhtx2y{margin-left:0}.form.svelte-1yhtx2y button.svelte-1yhtx2y.svelte-1yhtx2y{margin:10px;padding:10px 45px;border:none;border-radius:5px;background-color:#3c96af;color:white;font-size:20px;cursor:pointer}.form.svelte-1yhtx2y button.svelte-1yhtx2y.svelte-1yhtx2y:hover{background-color:#347e8a}.form.svelte-1yhtx2y .section-button.svelte-1yhtx2y.svelte-1yhtx2y{padding:10px;width:50%;display:flex;justify-content:flex-end}",
      map: null
    };
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css2);
      return `${$$result.head += `<!-- HEAD_svelte-n3ior8_START -->${$$result.title = `<title>Home</title>`, ""}<!-- HEAD_svelte-n3ior8_END -->`, ""}
<section class="${"section-bg svelte-1yhtx2y"}"><header class="${"section-bg__header-bg"}"><h1 class="${"text-5xl"}">Dise\xF1o y desarrollo de aplicaciones web</h1>
    <div class="${"section-bg__header-bg-location svelte-1yhtx2y"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" class="${"icon icon-tabler icon-tabler-map-pin"}" width="${"74"}" height="${"74"}" viewBox="${"0 0 24 24"}" stroke-width="${"1.5"}" stroke="${"#C4A53A"}" fill="${"none"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}"><path stroke="${"none"}" d="${"M0 0h24v24H0z"}" fill="${"none"}"></path><circle cx="${"12"}" cy="${"11"}" r="${"3"}"></circle><path d="${"M17.657 16.657l-4.243 4.243a2 2 0 0 1 -2.827 0l-4.244 -4.243a8 8 0 1 1 11.314 0z"}"></path></svg>
      <p class="${"svelte-1yhtx2y"}">Ilo, Moquegua</p></div>
    <button class="${"section-bg__header-bg-button svelte-1yhtx2y"}">Contactar</button></header>
  <div class="${"layer-black svelte-1yhtx2y"}"><div class="${"img-background svelte-1yhtx2y"}"></div></div></section>

<main class="${"main svelte-1yhtx2y"}"><header class="${"main__header svelte-1yhtx2y"}"><h2>Mis servicios</h2></header>
  <section class="${"section-services svelte-1yhtx2y"}"><article class="${"svelte-1yhtx2y"}"><header class="${"svelte-1yhtx2y"}">Dise\xF1o Web</header>
      <div class="${"article__bg-icon svelte-1yhtx2y"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" class="${"icon icon-tabler icon-tabler-palette"}" width="${"44"}" height="${"44"}" viewBox="${"0 0 24 24"}" stroke-width="${"1.5"}" stroke="${"#2c3e50"}" fill="${"none"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}"><path stroke="${"none"}" d="${"M0 0h24v24H0z"}" fill="${"none"}"></path><path d="${"M12 21a9 9 0 1 1 0 -18a9 8 0 0 1 9 8a4.5 4 0 0 1 -4.5 4h-2.5a2 2 0 0 0 -1 3.75a1.3 1.3 0 0 1 -1 2.25"}"></path><circle cx="${"7.5"}" cy="${"10.5"}" r="${".5"}" fill="${"currentColor"}"></circle><circle cx="${"12"}" cy="${"7.5"}" r="${".5"}" fill="${"currentColor"}"></circle><circle cx="${"16.5"}" cy="${"10.5"}" r="${".5"}" fill="${"currentColor"}"></circle></svg></div>
      <p class="${"svelte-1yhtx2y"}">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Blanditiis
    ...
    <article class="${"svelte-1yhtx2y"}"><header class="${"svelte-1yhtx2y"}">Aplicaciones moviles</header>
      <div class="${"article__bg-icon svelte-1yhtx2y"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" class="${"icon icon-tabler icon-tabler-brand-android"}" width="${"44"}" height="${"44"}" viewBox="${"0 0 24 24"}" stroke-width="${"1.5"}" stroke="${"#2c3e50"}" fill="${"none"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}"><path stroke="${"none"}" d="${"M0 0h24v24H0z"}" fill="${"none"}"></path><line x1="${"4"}" y1="${"10"}" x2="${"4"}" y2="${"16"}"></line><line x1="${"20"}" y1="${"10"}" x2="${"20"}" y2="${"16"}"></line><path d="${"M7 9h10v8a1 1 0 0 1 -1 1h-8a1 1 0 0 1 -1 -1v-8a5 5 0 0 1 10 0"}"></path><line x1="${"8"}" y1="${"3"}" x2="${"9"}" y2="${"5"}"></line><line x1="${"16"}" y1="${"3"}" x2="${"15"}" y2="${"5"}"></line><line x1="${"9"}" y1="${"18"}" x2="${"9"}" y2="${"21"}"></line><line x1="${"15"}" y1="${"18"}" x2="${"15"}" y2="${"21"}"></line></svg>

        <svg xmlns="${"http://www.w3.org/2000/svg"}" class="${"icon icon-tabler icon-tabler-brand-apple"}" width="${"44"}" height="${"44"}" viewBox="${"0 0 24 24"}" stroke-width="${"1.5"}" stroke="${"#2c3e50"}" fill="${"none"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}"><path stroke="${"none"}" d="${"M0 0h24v24H0z"}" fill="${"none"}"></path><path d="${"M9 7c-3 0 -4 3 -4 5.5c0 3 2 7.5 4 7.5c1.088 -.046 1.679 -.5 3 -.5c1.312 0 1.5 .5 3 .5s4 -3 4 -5c-.028 -.01 -2.472 -.403 -2.5 -3c-.019 -2.17 2.416 -2.954 2.5 -3c-1.023 -1.492 -2.951 -1.963 -3.5 -2c-1.433 -.111 -2.83 1 -3.5 1c-.68 0 -1.9 -1 -3 -1z"}"></path><path d="${"M12 4a2 2 0 0 0 2 -2a2 2 0 0 0 -2 2"}"></path></svg></div>
      <p class="${"svelte-1yhtx2y"}">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsam facilis
    ...
    <article class="${"svelte-1yhtx2y"}"><header class="${"svelte-1yhtx2y"}">E-commerce</header>
      <div class="${"article__bg-icon svelte-1yhtx2y"}"><svg xmlns="${"http://www.w3.org/2000/svg"}" class="${"icon icon-tabler icon-tabler-shopping-cart"}" width="${"44"}" height="${"44"}" viewBox="${"0 0 24 24"}" stroke-width="${"1.5"}" stroke="${"#2c3e50"}" fill="${"none"}" stroke-linecap="${"round"}" stroke-linejoin="${"round"}"><path stroke="${"none"}" d="${"M0 0h24v24H0z"}" fill="${"none"}"></path><circle cx="${"6"}" cy="${"19"}" r="${"2"}"></circle><circle cx="${"17"}" cy="${"19"}" r="${"2"}"></circle><path d="${"M17 17h-11v-14h-2"}"></path><path d="${"M6 5l14 1l-1 7h-13"}"></path></svg></div>
      <p class="${"svelte-1yhtx2y"}">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nam veritatis
  ...
  <h2 class="${"contact font-bold svelte-1yhtx2y"}">Contacto</h2>
  <form class="${"form svelte-1yhtx2y"}" id="${"form"}"><h3 class="${"text-2xl py-2 svelte-1yhtx2y"}">Contactanos llenando todos los campos</h3>
    <section class="${"form__first-section svelte-1yhtx2y"}"><label for="${""}" class="${"svelte-1yhtx2y"}"><span>Nombre</span>
        <input type="${"text"}" placeholder="${"Nombre"}" name="${"name"}" class="${"svelte-1yhtx2y"}"></label>

      <label for="${""}" class="${"svelte-1yhtx2y"}"><span>Telefono</span>
        <input type="${"text"}" placeholder="${"Telefo"}" name="${"telephone"}" class="${"svelte-1yhtx2y"}"></label></section>

    <section class="${"form__second-section svelte-1yhtx2y"}"><label for="${""}" class="${"svelte-1yhtx2y"}"><span>Correo</span>
        <input type="${"email"}" name="${"email"}" class="${"svelte-1yhtx2y"}"></label>

      <label for="${""}" class="${"svelte-1yhtx2y"}"><span>Mensaje</span>
        <textarea name="${"message"}" class="${"svelte-1yhtx2y"}"></textarea></label></section>
    <section class="${"section-button svelte-1yhtx2y"}"><button type="${"submit"}" class="${"svelte-1yhtx2y"}">Enviar</button></section></form>
</main>`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    file3 = "_app/immutable/components/pages/_page.svelte-9ecece7e.js";
    imports3 = ["_app/immutable/components/pages/_page.svelte-9ecece7e.js", "_app/immutable/chunks/index-98708bfc.js"];
    stylesheets3 = ["_app/immutable/assets/_page-c2bc6f05.css"];
  }
});

// .svelte-kit/output/server/entries/pages/clientes/_page.svelte.js
...
var init_page_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/clientes/_page.svelte.js"() {
    ...
    Page2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let data = [];
      return `<h1 class="${"text-5xl m-4"}">Clientes</h1>


<section class="${"grid grid-cols-3 gap-8 mx-4"}">${each(data, (item, idx) => {
        return `<article class="${"overflow-hidden rounded-lg shadow-lg"}"><a href="${"#"}"><img alt="${"Placeholder"}" class="${"block h-auto w-full"}"${add_attribute("src", `https://xsgames.co/randomusers/assets/avatars/male/${idx + 1}.jpg`, 0)}></a>
      <header class="${"flex items-center justify-between leading-tight p-2 md:p-4"}"><h1 class="${"text-lg"}"><a class="${"no-underline hover:underline text-black"}" href="${"#"}">${escape(item.name)}
          </a></h1>
        <p class="${"text-grey-darker text-sm"}">${escape(item.email)}</p></header>

      <footer class="${"flex items-center justify-between leading-none p-2 md:p-4"}"><a class="${"flex items-center no-underline hover:underline text-black"}" href="${"#"}"><p class="${"ml-2 text-sm"}">${escape(item.phone)}</p>
        </a></footer>
    </article>`;
      })}
</section>`;
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    file4 = "_app/immutable/components/pages/clientes/_page.svelte-0618f842.js";
    imports4 = ["_app/immutable/components/pages/clientes/_page.svelte-0618f842.js", "_app/immutable/chunks/index-98708bfc.js"];
    stylesheets4 = [];
  }
});

// .svelte-kit/output/server/entries/pages/contactos/_page.svelte.js
...
var init_page_svelte3 = __esm({
  ".svelte-kit/output/server/entries/pages/contactos/_page.svelte.js"() {
    init_chunks();
    css3 = {
      code: "h1.svelte-1guw7ld{text-align:center}section.svelte-1guw7ld{display:flex;justify-content:center}article.svelte-1guw7ld{width:50%}img.svelte-1guw7ld{width:100%}",
      map: null
    };
    Page3 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css3);
      return `<h1 class="${"text-center text-5xl m-2 svelte-1guw7ld"}">Contactos</h1>

<section class="${"my-8 svelte-1guw7ld"}"><article class="${"svelte-1guw7ld"}"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium hic
      molestiae ab nihil veniam amet blanditiis, pariatur nam ut consequuntur
      quasi beatae laboriosam provident, officia earum nobis, est quidem
      corporis. Lorem ipsum dolor sit amet consectetur adipisicing elit.
      Eveniet, corrupti! Tempora, itaque doloribus eveniet iure, facere illo
      quod adipisci, architecto nam incidunt eligendi officia odit corporis
      veritatis expedita unde quasi?
    </p>

    <figure><img src="${"https://picsum.photos/600/300"}" alt="${"Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium hic molestiae ab nihil veniam amet blanditiis, pariatur nam ut consequuntur quasi beatae laboriosam provident, officia earum nobis, est quidem corporis."}" class="${"svelte-1guw7ld"}"></figure></article>
</section>`;
    });
  }
});
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    ...
    file5 = "_app/immutable/components/pages/contactos/_page.svelte-3a86a15c.js";
    imports5 = ["_app/immutable/components/pages/contactos/_page.svelte-3a86a15c.js", "_app/immutable/chunks/index-98708bfc.js"];
    stylesheets5 = ["_app/immutable/assets/_page-a3c78e52.css"];
  }
});

// .svelte-kit/output/server/entries/pages/nosotros/_page.svelte.js
...
var init_page_svelte4 = __esm({
  ".svelte-kit/output/server/entries/pages/nosotros/_page.svelte.js"() {
    init_chunks();
    css4 = {
      code: "section.svelte-1gg0ft{display:flex;justify-content:center}article.svelte-1gg0ft{width:50%}img.svelte-1gg0ft{width:100%}",
      map: null
    };
    Page4 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css4);
      return `<h1 class="${"text-center text-5xl m-2 class="}">Nosotros</h1>
<section class="${"my-8 svelte-1gg0ft"}"><article class="${"svelte-1gg0ft"}"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium hic
      molestiae ab nihil veniam amet blanditiis, pariatur nam ut consequuntur
      quasi beatae laboriosam provident, officia earum nobis, est quidem
      corporis. Lorem ipsum dolor sit amet consectetur adipisicing elit.
      Eveniet, corrupti! Tempora, itaque doloribus eveniet iure, facere illo
    ...
    <figure><img src="${"https://picsum.photos/400/300"}" alt="${"Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium hic molestiae ab nihil veniam amet blanditiis, pariatur nam ut consequuntur quasi beatae laboriosam provident, officia earum nobis, est quidem corporis."}" class="${"svelte-1gg0ft"}"></figure></article>
</section>`;
    });
  }
});
...
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    ...
    file6 = "_app/immutable/components/pages/nosotros/_page.svelte-4159002f.js";
    imports6 = ["_app/immutable/components/pages/nosotros/_page.svelte-4159002f.js", "_app/immutable/chunks/index-98708bfc.js"];
    stylesheets6 = ["_app/immutable/assets/_page-4ae32cb6.css"];
  }
});
...
var manifest = {
  appDir: "_app",
  appPath: "_app",
  assets: /* @__PURE__ */ new Set(["favicon.png", "mac.jpg"]),
  mimeTypes: { ".png": "image/png", ".jpg": "image/jpeg" },
  _: {
    entry: { "file": "_app/immutable/start-5b22a1e6.js", "imports": ["_app/immutable/start-5b22a1e6.js", "_app/immutable/chunks/index-98708bfc.js", "_app/immutable/chunks/singletons-dd516ea2.js"], "stylesheets": [] },
    nodes: [
